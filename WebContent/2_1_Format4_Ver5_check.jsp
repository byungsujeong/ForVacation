...
<%
	...
	userDTO.setMid((String) session.getAttribute("id"));
...
%>  
        ...
        <script>
          ...
          //예약확인 버튼 클릭시 함수
            function reservationcheck() {
				location.href="ReservationListUser.jsp?regnum=<%=userDTO.getRegNum()%>";
				//-->예약요청 목록으로 사업자 view
			}
			//예약확인 버튼 클릭시 함수
    ...
    <br><br><br><br>
        <table border="1" align="center">
            <form id="joinmem" name="joinmem" action="updateUser.jsp">
                <tr class="header">
                    <td colspan="3">제목(모든 입력사항은 필수 입니다.)</td>
                </tr>
                <tr class="input">
                    <td>사업자번호:</td>
                    <td><input type="text" name="regNum" id="regNum" value="<%=userDTO.getRegNum()%>">
                        <!-- 사업자 번호 입력창 -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>사업장이름:</td>
                    <td><input type="text" name="storename" id="storename" value="<%=userDTO.getStorename()%>">
                        <!-- 사업장 이름 입력창 -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" id="postcode" name="postcode" placeholder="우편번호" value="<%=userDTO.getPostcode()%>">
                        <!-- 우편번호 입력창(주소입력 api에서 가져오기) -->
                    </td>
                    <td>
                        <!--  <input type="text " name="Saddress2 " id="Saddress2 "> -->
                        <input type="text" id="roadAddress" name="roadAddress" placeholder="도로명주소" value="<%=userDTO.getRoadAddress()%>">
                        <!-- 주소 입력창(주소입력 api에서 가져오기) -->
                    </td>
                    <td>
                        <!-- <input type="text " name="Saddress3 " id="Saddress3 "> -->
                        <span id="guide " style="color: #999; display: none"></span>
                        <input type="text" id="detailAddress" name="detailAddress" placeholder="상세주소" value="<%=userDTO.getDetailAddress()%>">
                        <!-- 상세주소 사용자 입력 -->
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="type">
 					 <option value="cafe" <%if (userDTO.getType() == "cafe") {%> selected<%}%>>카페</option>
 					 <option value="factory" <%if (userDTO.getType() == "factory") {%> selected<%}%>>음식</option>
 					 <option value="design" <%if (userDTO.getType() == "design") {%> selected<%}%>>기타</option>
				</select>
                    </td>
                </tr>
                <tr>
                    <td>사업장규모:</td>
                    <td>
                        <input type="text" name="sSize" id="sSize" value="<%=userDTO.getsSize()%>">상시 근로인원, 월매출등
                        <!-- 휴대폰번호 입력창 -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3 "><input type="text" name="sInfo" id="sInfo" value="<%=userDTO.getsInfo()%>">사업장 소개 및 영업시간 등 상세
                ...
                <tr>
                	<td>
                		<input type="hidden" name="sImgsrc" id="sImgsrc" <%-- value="<%=userDTO.getsImgsrc()%>" --%>>
                ...
                <tr>
                    <td>
                        <input id="joinmemsubmit" type="submit" value="사업자정보 수정 완료">
                    ...
                    <td>
                        <button type="button">
						<a href="deleteUser.jsp?regNum=<%=userDTO.getRegNum()%>">사업자등록 취소</a>
						<!-- 등록 닫기 혹은 이전으로 돌아가기 -->
						</button>
                    </td>
                    <td>
                    	<button type="button" id="reservationcheck" onclick="reservationcheck();">예약확인</button>
                    </td>
                </tr>
            <tr>
                <td>사업장 사진:</td>
                <td id="imgpreview" width="300" height="200">
                    <img id="preview" width="300" height="auto" src=<%=userDTO.getsImgsrc()%> />
